...
- `scripts/sync-opencode.js` already copied and cleaned the deployed workflow.
...
| `package/opencode-roundhouse.js` | Create | Published explicit deployment CLI |
| `package/deploy-roundhouse.js` | Create | Published shared deployment implementation |
| `scripts/sync-opencode.js` | Modify | Reuse shared implementation |

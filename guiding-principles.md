...
- Operationalized: `markdownlint-cli2` enforces Markdown structure (see `docs/decisions/2026-08-29-markdownlint-via-npx.md`); `AGENTS.md` states the *trigger*, the config holds the *rules*; the document-author runs the check and reports `verify-status`

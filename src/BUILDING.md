...
4. The harness-writer will guide you through initial workflow setup
...
2. If non-trivial, the pipeline will route through:
   ...
   - Harness Writer: executes the approved plan, returns a completion packet
   - Review lanes: harness-reviewer + peer-reviewer (parallel, isolated, scoped to the change)
